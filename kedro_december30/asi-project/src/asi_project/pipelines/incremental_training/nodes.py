...
def incremental_train_rf(x_train_additional: pd.DataFrame, y_train_additional: pd.Series, rf_model_path: str) -> None:
...
def incremental_train_gb(x_train_additional: pd.DataFrame, y_train_additional: pd.Series, gb_model_path: str) -> None:
